...
import { CardMedia, Card, CardContent, Box, Stack , Grid, Divider} from "@mui/material"
...
<Grid container spacing={2}>
        ...
        <CardContent>
          ...
          <Card sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
            ...
            <CardContent sx={{ flex: 1 }}>
              <Heading level="h3" size="h6">Local Artisan Market</Heading>
              <Paragraph size="sm">
                Weekly market featuring local crafts, food, and live music.
              </Paragraph>
            </CardContent>
          </Card>
  ...
  {/* Right Column - Map */}
  <Grid size={7}>
    <Box sx={{ height: '100%', border: '1px solid #ddd', borderRadius: 1, p: 2 }}>
      <p>MAP HERE</p>
    </Box>
  </Grid>
</Grid>
